#' Confluent mphypergeometric1F1 function
#'
#' Compute the Confluent Hypergeometric function with mpfr: 1F1(a,b,c,t) =
...
#' @keywords math
#' @examples
#' mphypergeometric1F1(11.14756, 0.5, 0.00175097)
#'
#'
#' @rdname mphypergeometric1F1
#' @family special functions
#' @export 
mphypergeometric1F1 = function(a,b,c, laplace=FALSE, log=TRUE) {
  
  n = length(a);
  out = rep(0, n);
  ans = .C(C_mphypergeometric1F1, as.numeric(a), as.numeric(b), as.numeric(c), out=as.numeric(out), as.integer(n),
